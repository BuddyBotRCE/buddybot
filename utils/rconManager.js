            ...
            try {
                ...
                if (adminPosQueue.size > 0) {
                    for (const [adminId, setupData] of adminPosQueue.entries()) {
                        ...
                        // TACTIC 1: Catch "Naked" Coordinates generated by printpos! e.g. (-1701.84, 2.08, 1521.82)
...
async function queueAdminPos(interaction, type = 'custom_bind') {
    ...
    // Give it 8 seconds to get the reply
    ...
    try {
        // This is what forces the server to output your coordinates!
