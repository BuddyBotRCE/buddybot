                        ...
                        if (foundPos) {
                            ...
                            if (setupData.type === 'custom_bind') {
                                try {
                                    ...
                                    if (bind) {
                                       // Updated to use teleport2pos syntax
                                       let command = bind.actionType === 'teleport' ? `teleport2pos "${setupData.inGameName}" ${posX} ${posY} ${posZ}` : `spawn recycler_static (${posX},${posY},${posZ})`;
