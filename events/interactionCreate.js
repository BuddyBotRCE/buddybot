...
const { GuildConfig, UserEconomy, Giveaway, CustomBind, BindCooldown, ServerKit, ShopItem, ShopCooldown, CasinoCooldown, OrpConfig, PlayerOrpBase, BuddyPassChallenge, BuddyPassReward, TicketCategory, PveZone, ActiveBounty, BountyCooldown } = require('../database/db');
    ...
    try {
        ...
        if (interaction.isModalSubmit()) {
            ...
            if (interaction.customId === 'modal_link_account') {
                ...
                return interaction.reply({ content: `✅ Successfully linked your Discord to Rust account: **${ign}**!\nYou can now use the shop, kits, and teleports.`, flags: 64 });
            }
