...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const embed = new EmbedBuilder()
            ...
            .setDescription(`Welcome to the community hub! Manage your Rust account, access banking, play casino minigames, view leaderboards, manage your Clan, or browse the store.`)
            .setColor('#3498db')
            .setTimestamp();
