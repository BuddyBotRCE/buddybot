        ...
        if (interaction.isButton()) {
            ...
            if (customId.startsWith('btn_clan_bank_')) {
                ...
                const embed = new EmbedBuilder()
                    ...
                    .setDescription(`Current Balance: **${clan.bankBalance} ${currency}**\n\nChoose an option below to deposit funds from your wallet or withdraw funds as the clan leader.`)
                    .setColor('#2ecc71');
